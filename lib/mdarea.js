...
export default class MDArea extends HTMLElement {
    ...
    connectedCallback () {
        ...
        console.log(textareaStyle["background-color"]);
        ...
        this.style.setProperty('--padding-top', `calc(${toolBar.offsetHeight}px + ${textareaStyle["padding-top"]} + ${textareaStyle["border-top-width"]})`)
        ...
        // Bump to end of callstack because if textarea was not already on dom, it needs to be connected in order to get style
        setTimeout(() => {
